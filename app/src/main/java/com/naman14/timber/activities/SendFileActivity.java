...
import com.naman14.timber.adapters.DeviceAdapter;
import com.naman14.timber.broadcast.DirectBroadcastReceiver;
import com.naman14.timber.callback.DirectActionListener;
import com.naman14.timber.common.LoadingDialog;
import com.naman14.timber.models.FileTransfer;
import com.naman14.timber.task.WifiClientTask;

public class SendFileActivity extends WifiBaseActivity implements DirectActionListener {
...
//        getMenuInflater().inflate(R.menu.action, menu);
    ...
    public void onSelfDeviceAvailable(WifiP2pDevice wifiP2pDevice) {
        ...
        tv_myDeviceStatus.setText(WifiMainActivity.getDeviceStatus(wifiP2pDevice.status));
    }
