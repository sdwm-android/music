...
public class MainActivity extends BaseActivity implements ATEActivityThemeCustomizer {
    ...
    private Runnable navigateMusicsQuare = new Runnable() {
        public void run() {
            Toast.makeText(MainActivity.this, "等待添加", Toast.LENGTH_SHORT).show();

        }
    };

    private Runnable navigateFastSend = new Runnable() {
        public void run(){
            navigationView.getMenu().findItem(R.id.nav_fastsend).setChecked(true);
                Intent intent = new Intent(MainActivity.this,WifiMainActivity.class);
...
//            transaction.replace(R.id.fragment_container, fragment).commit();
    ...
    private void setupNavigationIcons(NavigationView navigationView) {
        ...
        if (!isDarkTheme) {
            ...
            navigationView.getMenu().findItem(R.id.nav_musicsquare).setIcon(R.drawable.musics_quare);
            ...
            navigationView.getMenu().findItem(R.id.nav_fastsend).setIcon(R.drawable.fast_send);
            ...
            navigationView.getMenu().findItem(R.id.nav_musicsquare).setIcon(R.drawable.music_square_white);
            ...
            navigationView.getMenu().findItem(R.id.nav_fastsend).setIcon(R.drawable.fast_send_white);
    ...
    private void updatePosition(final MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.nav_playlists:
                ...
                break;
            case R.id.nav_musicsquare:
                runnable = navigateMusicsQuare;

                break;
            case R.id.nav_fastsend:
                runnable = navigateFastSend;
